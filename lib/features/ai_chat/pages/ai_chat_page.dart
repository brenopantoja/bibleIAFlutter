...
class _AiChatPageState extends State<AiChatPage> {
  ...
  void initState() {
    ...
    controller = AiChatController(
      repository: AiRepository(datasource: AiRemoteDatasource()),
    );
    controller.addListener(_refresh);
    BibleProvider.instance.addListener(_refresh);
  }
  ...
  void dispose() {
    ...
    BibleProvider.instance.removeListener(_refresh);
    controller.dispose();
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      drawer: const AppDrawer(version: '1.0.0'),
      appBar: AppBar(
        title: const Text('Bible IA'),
        actions: [
          IconButton(
            tooltip: english ? 'Clear conversation' : 'Limpar conversa',
      ...
      body: Column(
        children: [
          ...
          InputBar(
            ...
            hintText: english ? 'Ask your question...' : 'Digite sua pergunta...',
            onSend: () async {
